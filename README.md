...
- 01.06.2026 Добавлена проверка на количество продукта при его создании. (Запрет на создание с количеством 0.)
- 01.06.2026 Добавлено в класс Category метод middle_price.
____
## Установка и запуск
...
src\product.py              71      4    94%
src\utils.py                19      8    58%
tests\__init__.py            0      0   100%
tests\conftest.py            5      0   100%
tests\test_category.py      57      0   100%
tests\test_product.py       86      0   100%
